<x-layouts.admin title="Verification Queue">
    <div class="p-4 md:p-8 max-w-7xl mx-auto flex flex-col md:h-full min-h-0" x-data="{ openLightbox: false, activeImage: '' }" @keydown.escape.window="openLightbox = false">
        ...
        <!-- Table -->
        <div class="bg-gray-900 border border-gray-800 rounded-2xl md:flex-grow md:overflow-hidden shadow-lg flex flex-col">
            <div class="md:flex-1 overflow-x-auto overflow-y-visible md:overflow-y-auto">
